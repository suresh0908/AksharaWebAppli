                                ...
                                <div class="panel panel-default">
                                    ...
                                    CausesValidation="false" />
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <asp:TextBox ID="txtcmpchit" runat="server" CssClass="form-control" autocomplete="off" ReadOnly="true"/>
                                                            ...
                                                            <div class="col-md-4">
                                                                <asp:TextBox ID="txtgrpcode" runat="server" CssClass="form-control" autocomplete="off" ReadOnly="true"/>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <asp:CheckBox runat="server" ID="chk_editgrup" Text="Edit Group" CssClass="checkbox checkbox-inline" AutoPostBack="true" OnCheckedChanged="chk_editgrup_CheckedChanged" />
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <asp:TextBox ID="txtinstlmt" runat="server" CssClass="form-control" autocomplete="off" ReadOnly="true"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:Button runat="server" Text="Save" CssClass="btn btn-default btn-success" ID="btnfdr" OnClick="btnfdr_Click" ValidationGroup="grfm" />
                                                &nbsp;&nbsp;
                                                <asp:Button runat="server" Text="Clear" CssClass="btn btn-default btn-danger" ID="btngrpclr" />
                                                <asp:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="btnfdr" ConfirmText="Are you sure?" />
                                            </div>
                                        </div>
                                        <div class="clr">
                                        </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    CausesValidation="false" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtpsono" runat="server" CssClass="form-control utxt" autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtcommdt" runat="server" CssClass="form-control datepicker" ClientIDMode="Static" OnTextChanged="txtcommdt_TextChanged" onkeydown="return false" AutoPostBack="true"/>
                                                <asp:CompareValidator ID="compvdt1" runat="server" ControlToValidate="txtcommdt" ControlToCompare="txtpsoregdt" Operator="GreaterThanEqual" ErrorMessage="Commence Date Must be >= PSO Date" CssClass="text-danger" ValidationGroup="regfrm" />
                                            </div>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel8" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txttermdt" runat="server" CssClass="form-control datepicker" ClientIDMode="Static" ReadOnly="true"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:Button runat="server" Text="Save" CssClass="btn btn-default btn-success" ID="btnregsave" ValidationGroup="regfrm" OnClick="btnregsave_Click" />&nbsp;&nbsp;
                                                <asp:Button runat="server" Text="Clear" CssClass="btn btn-default btn-danger" ID="btnregclear" />
                                                <asp:ConfirmButtonExtender ID="cmext1" runat="server" TargetControlID="btnregsave" ConfirmText="Are you sure?" />
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <asp:RadioButton ID="rbnregall" runat="server" CssClass="radio radio-inline" GroupName="grp" Text="All Groups" TextAlign="Right" />
                                                <asp:RadioButton ID="rbnrunng" runat="server" CssClass="radio radio-inline" GroupName="grp" Text="Running Groups" TextAlign="Right" />
                                                <asp:RadioButton ID="rbncomplt" runat="server" CssClass="radio radio-inline" GroupName="grp" Text="Completed Groups" TextAlign="Right" />
                                            </div>
                                            <div class="col-md-3">
