...
namespace DataLyr
{
    public class backend_master
    {
        ...
        public DataSet get_Dataset(string qry)
        {
            DataSet dss;
            cm = new NpgsqlCommand(qry, cn);
            da = new NpgsqlDataAdapter(cm);
        ...
        public void load_dropid(string qry, DropDownList txt, string fst, string secnd_value, string value)
        {
            try
            {
                txt.Items.Clear();
